    ...
    object Commerce1: TMenuItem
      ...
      object Commerce2: TMenuItem
        ...
        object CommerceB1: TMenuItem
          Caption = 'Commerce B'
          OnClick = CommerceB1Click
        end
        object CommerceC1: TMenuItem
          Caption = 'Commerce C'
          OnClick = CommerceC1Click
        end
        object CommerceD1: TMenuItem
          Caption = 'Commerce D'
          OnClick = CommerceD1Click
        end
      end
      object Industrie1: TMenuItem
        ...
        object IndustrieA1: TMenuItem
          Caption = 'Industrie A'
          OnClick = IndustrieA1Click
        end
        object IndustrieB1: TMenuItem
          Caption = 'Industrie B'
          OnClick = IndustrieB1Click
        end
        object IndustrieC1: TMenuItem
          Caption = 'Industrie C'
          OnClick = IndustrieC1Click
        end
        object IndustrieD1: TMenuItem
          Caption = 'Industrie D'
          OnClick = IndustrieD1Click
        end
        object IndustrieE1: TMenuItem
          Caption = 'Industrie E'
          OnClick = IndustrieE1Click
        end
      end
